(function() {
  ...
  ProjectRepository = (function(superClass) {
    ...
    ProjectRepository.prototype.listBranches = function(projectId, fn) {
      ...
      // console.log('listBranches',"projects/" + (Utils.parseProjectId(projectId)) + "/repository/branches")
    ...
    ProjectRepository.prototype.showBranch = function(projectId, branchId, fn) {
      ...
      console.log("projects/" + (Utils.parseProjectId(projectId)) + "/repository/branches/" + (encodeURI(branchId)));
    ...
    //TODO add since until
    ProjectRepository.prototype.listCommits = function(projectId, branchName,fn) {
      ...
      if (fn == null) {
        fn = null;
            ...
            // console.log("listCommits","projects/" + (Utils.parseProjectId(projectId)) + "/repository/commits"+branchName)

      this.debug("Projects::listCommits()");
      return this.get("projects/" + (Utils.parseProjectId(projectId)) + "/repository/commits"+branchName, (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
    ...
    ProjectRepository.prototype.showCommit = function(projectId, commitId, fn) {
      ...
      // console.log("projects/" + (Utils.parseProjectId(projectId)) + "/repository/commits/" + commitId)
      return this.get("projects/" + (Utils.parseProjectId(projectId)) + "/repository/commits/" + commitId, (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
